...
See [complete documentation](http://htmlpreview.github.io/?https://raw.githubusercontent.com/margarito/ng-db-helper/master/documentation/index.html)
...
class TodosPage implements OnInit {
  ...
  public ngOnInit() {
    // retrieve not done and not passed todos
